...
#     "mael ollivier henry", "ayan nag", "Ben Bauchau", "Syd Mead", "dariusz zawadzki",

# artists = [ "huleeb", "frank mccarty",
#     "Oscar Berninghaus", "Jim C Norton", "Thomas Cole", "makoto Shinkai", "Hiroshi Yoshida", "Sin jong hun", "Miyazaki",
#     "Ivan Bilibin", "Studio Ghibli", "Cedric Peyravernay", "Peter Mohrbacher", ]

# artists = [ "Tom Bagshaw", "Karol Bak",
